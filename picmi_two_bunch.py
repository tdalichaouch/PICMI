...
k_pe = w_pe/cst.c
# plasma_min     = [-7.5/k_pe, -7.5/k_pe,  -100.0/k_pe]
# plasma_max     = [ 7.5/k_pe,  7.5/k_pe,  100.0/k_pe]
plasma_min     = [None,  None, -0.0/k_pe]
plasma_max     = [None,  None,  100.0/k_pe]
...
sim = picmi.Simulation(solver = solver, verbose = 1, QuickPIC_n0 = plasma_density,\
	QuickPIC_nodes = [128, 1], time_step_size = 10.0/w_pe, max_time =100.0/w_pe)
...
sim.write_input_file('qpinput.json')
